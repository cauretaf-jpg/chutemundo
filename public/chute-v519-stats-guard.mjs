...
function decorateTournamentForm() {
  ...
  if (!form || form.querySelector('[data-cm-v519-era]')) return;
  const note = document.createElement('div');
  note.dataset.cmV519Era = '';
...
window.ChuteV519StatsGuard = { version: VERSION, validShootout, divisionsCriticalIssues };
