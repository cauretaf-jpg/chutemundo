...
*/
await import('/chute-bootstrap.mjs?v=5.24.2');
await import('/chute-v511-assets.mjs?v=5.11.0');
await import('/chute-official-loader.mjs?v=5.24.2');
await import('/password-reset.mjs?v=3.0.3');
await import('/chute-detail.mjs?v=5.24.2');
...
await import('/chute-v521-history.mjs?v=5.24.2');
await import('/chute-v521-history-sync.mjs?v=5.24.2');
await import('/chute-v522-stats-refinement.mjs?v=5.24.2');
await import('/chute-v522-historical-dates.mjs?v=5.22.2');
await import('/chute-v523-control-center.mjs?v=5.24.2');
await import('/chute-v524-form-dirty-guard.mjs?v=5.24.2');
await import('/chute-v524-tournaments.mjs?v=5.24.2');
await import('/chute-v524-tournament-render-guard.mjs?v=5.24.2');
await import('/chute-v5241-history-collapse.mjs?v=5.24.2');
await import('/chute-v520-stats-guard.mjs?v=5.24.2');
await import('/chute-v5242-ui-fixes.mjs?v=5.24.2');
window.ChuteVersion?.apply?.();
document.dispatchEvent(new CustomEvent('chute:boot-complete', {
  detail: { version: window.ChuteVersion?.version || '5.24.2', core: window.ChuteMundoCore }
}));