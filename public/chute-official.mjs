...
await import('/chute-detail.mjs?v=5.23.0');
...
await import('/chute-v521-history.mjs?v=5.23.0');
await import('/chute-v521-history-sync.mjs?v=5.23.0');
await import('/chute-v522-stats-refinement.mjs?v=5.23.0');
await import('/chute-v522-historical-dates.mjs?v=5.22.2');
await import('/chute-v523-control-center.mjs?v=5.23.0');
await import('/chute-v520-stats-guard.mjs?v=5.23.0');
window.ChuteVersion?.apply?.();
document.dispatchEvent(new CustomEvent('chute:boot-complete', {
  detail: { version: window.ChuteVersion?.version || '5.23.0', core: window.ChuteMundoCore }
}));
