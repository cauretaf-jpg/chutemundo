...
const CACHE = 'chute-mundo-v5.24.1';
const CORE = [
  '/', '/index.html',
  '/chute-bootstrap.mjs?v=5.24.1',
  '/chute-official.css?v=5.16.0', '/chute-official.mjs?v=5.24.1', '/chute-official-loader.mjs?v=5.24.1',
  '/chute-detail.mjs?v=5.24.1', '/chute-v522-photo-fix.mjs?v=5.22.4', '/chute-v522-historical-dates.mjs?v=5.22.2',
  ...
  '/chute-v521-history.mjs?v=5.24.1', '/chute-v521-history.css?v=5.21.0', '/chute-v521-history-sync.mjs?v=5.24.1',
  ...Array.from({ length: 10 }, (_, index) => `/chute-v521-history-part-${String(index).padStart(2, '0')}.txt?v=5.21.0`),
  '/chute-v522-stats-refinement.mjs?v=5.24.1', '/chute-v522-stats-refinement.css?v=5.22.0',
  '/chute-v523-control-center.mjs?v=5.24.1', '/chute-v523-participants-admin.css?v=5.23.0',
  '/chute-v524-form-dirty-guard.mjs?v=5.24.1', '/chute-v524-tournaments.mjs?v=5.24.1', '/chute-v524-tournaments.css?v=5.24.1', '/chute-v524-tournament-render-guard.mjs?v=5.24.1',
  '/chute-v5241-history-collapse.mjs?v=5.24.1', '/chute-v5241-history-collapse.css?v=5.24.1',
  '/chute-v520-stats-guard.mjs?v=5.24.1',
