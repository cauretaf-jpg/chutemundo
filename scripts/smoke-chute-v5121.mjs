...
try{
  ...
  if(!/5\.(12\.1|13|14|15|16)/.test(result.title)||result.coreVersion!=='5.11.1'||result.searchVersion!=='5.12.1'||result.backupVersion!=='5.12.1'||!result.playerId.includes('__')||result.playerId.includes('::')||result.champion!=='a'||result.runnerUp!=='c'||result.width>result.viewport+3)throw new Error(JSON.stringify(result));
