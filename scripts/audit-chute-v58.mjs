...
requireCheck(official.includes("chute-official-loader.mjs?v=5.15.0"), 'No se invalida la cache del sistema principal v5.15.');
requireCheck(loader.includes("prefix: 'chute-official-part', count: 6, version: '5.15.0'"), 'El cargador principal no solicita las partes v5.15.');
