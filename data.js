  ...
  teams: [
    ...
    },
    {
      ...
      coachCard: {
        abbr: "DI",
        ability: "Dados 9",
        abilityDesc: "Si la suma de tus dados es 9 en alguna de tus acciones durante tu turno, puedes robar una carta. Límite: 1 vez por turno.",
        stadium: "Bahía Manglar",
        population: "897 habitantes"
      },
      players: [
        { name: "Eddy Pino", position: "Arquero", start: true, ataje: 9, paseCorto: 12, paseLargo: 8 },
        { name: "Donald Ortega", position: "Defensa", start: true, quite: 7, paseCorto: 4, paseLargo: 7, amague: 4, tiro: 5 },
        { name: "Ricky Watkins", position: "Delantero", start: true, quite: 6, paseCorto: 8, paseLargo: 4, amague: 7, tiro: 8 },
        { name: "Wilfredo Fernández", position: "Medio", start: true, quite: 6, paseCorto: 5, paseLargo: 8, amague: 8, tiro: 6 },
        { name: "Dino Richi", position: "Delantero", minute: 0, quite: 5, paseCorto: 6, paseLargo: 5, amague: 9, tiro: 8 },
        { name: "Jerold Bogan", position: "Medio", minute: 0, quite: 8, paseCorto: 7, paseLargo: 7, amague: 7, tiro: 7 },
        { name: "Dominic Mortensen", position: "Defensa", minute: 0, quite: 8, paseCorto: 4, paseLargo: 7, amague: 4, tiro: 4 },
        { name: "Mario Luna", position: "Defensa", minute: 20, quite: 8, paseCorto: 7, paseLargo: 8, amague: 4, tiro: 4 },
        { name: "Kelly Rivera", position: "Medio", minute: 20, quite: 7, paseCorto: 9, paseLargo: 7, amague: 9, tiro: 9 },
        { name: "Angelo Carboni", position: "Medio", minute: 20, quite: 8, paseCorto: 10, paseLargo: 7, amague: 8, tiro: 8 },
        { name: "Eric Perry", position: "Delantero", minute: 20, quite: 6, paseCorto: 6, paseLargo: 4, amague: 7, tiro: 10 },
        { name: "Burt McCloskey", position: "Defensa", minute: 45, quite: 11, paseCorto: 6, paseLargo: 9, amague: 3, tiro: 3 },
        { name: "Faustino Soriano", position: "Delantero", minute: 45, quite: 7, paseCorto: 9, paseLargo: 8, amague: 10, tiro: 10 },
        { name: "Boris Lentz", position: "Medio", minute: 45, quite: 7, paseCorto: 10, paseLargo: 9, amague: 9, tiro: 10 }
      ],
      objects: [
        { name: "Canilla de Palo", minute: "0'", effect: "+1 Quite", description: "Aumenta el quite en 1" },
        { name: "El Telescopio", minute: "10'", effect: "+1 Pase largo", description: "Aumenta el pase largo en 1" },
        { name: "Canilla de Fierro", minute: "10'", effect: "+2 Quite", description: "Aumenta el quite en 2" },
        { name: "Ojos de Mosca", minute: "10'", effect: "+2 Pase corto", description: "Aumenta el pase corto en 2" },
        { name: "Zancos", minute: "20'", effect: "+1 Movimiento", description: "Aumenta el movimiento del jugador en 1 espacio" },
        { name: "El Látigo", minute: "20'", effect: "+1 Amague", description: "Aumenta el amague en 1" },
        { name: "El Teledirigido", minute: "30'", effect: "+2 Pase largo", description: "Aumenta el pase largo en 2" },
        { name: "El Tronco", minute: "30'", effect: "-1 Amague rival", description: "Disminuye el amague de un jugador oponente en 1" },
        { name: "Piedra en el Zapato", minute: "30'", effect: "-1 Tiro al arco rival", description: "Disminuye el tiro al arco de un jugador oponente en 1" },
        { name: "Botín de Oro", minute: "45'", effect: "+1 en todas", description: "Aumenta todas las habilidades del jugador en 1 (no aplica al arquero)" },
        { name: "El Pulmón", minute: "45'", effect: "+1 Movimiento", description: "Aumenta el movimiento del jugador en 1 espacio" },
        { name: "El Sombrero", minute: "70'", effect: "Habilidad especial", description: "Puede realizar tiro al arco 1 espacio fuera del área" }
      ],
      specialActions: [
        { minute: 10, name: "De Primera", effect: "Sin dados", description: "Ejecuta un pase corto o largo sin tirar los dados" },
        { minute: 10, name: "Suerte de Goleador", effect: "Relanzar", description: "Permite relanzar los dados después de un tiro al arco (antes del ataje)" },
        { minute: 10, name: "Cañonazo", effect: "Pase efectivo", description: "Envía la pelota a cualquier jugador (cuenta como pase largo efectivo)" },
        { minute: 20, name: "Bicicleta", effect: "+3", description: "Después de un amague efectivo, suma +3 al valor total" },
        { minute: 20, name: "Cuerpo", effect: "Desplaza", description: "Desplaza a un rival adyacente y toma su lugar (sin pelota)" },
        { minute: 20, name: "Piscinazo", effect: "Descarte", description: "Envía a un rival a descarte (ambos en área rival y con pelota)" },
        { minute: 20, name: "Puntete", effect: "+3/-3", description: "Tras tiro efectivo: +3 si sacas ≥7, −3 si sacas <7" },
        { minute: 20, name: "La Culebra", effect: "Auto-quite", description: "Quita la pelota automáticamente ante un amague (turno rival)" },
        { minute: 30, name: "Levanta Muertos", effect: "Recupera", description: "Recupera un jugador desde descarte" },
        { minute: 30, name: "VAR", effect: "Repite tirada", description: "Obliga al rival a repetir su tirada" },
        { minute: 30, name: "La Trancada", effect: "+5", description: "+5 al quite después de un quite efectivo" },
        { minute: 30, name: "El Pulpo", effect: "+5", description: "+5 al ataje después de un ataje efectivo" },
        { minute: 30, name: "Memoria Muscular", effect: "Recupera", description: "Recupera una acción especial desde descarte" },
        { minute: 30, name: "La Chuleta", effect: "Descarte", description: "Tras quitar balón, envía al rival a descarte" },
        { minute: 45, name: "El Escorpión", effect: "Auto-pase", description: "Tras ataje, pase automático dentro de tu mitad" },
        { minute: 45, name: "La Palomita", effect: "Auto-tiro", description: "Tiro automático al recibir pase largo + posible +3" },
        { minute: 50, name: "Caza Talentos", effect: "Busca", description: "Busca un jugador en tu mazo y llévalo a tu mano" },
        { minute: 60, name: "Pifia", effect: "Descarte", description: "Envía a descarte un rival sin pelota (solo en tu turno)" },
        { minute: 80, name: "La Chilena", effect: "Auto-tiro", description: "Tiro automático al recibir pase largo + posible +6" }
      ]
    },
    {
      id: "pantera",
